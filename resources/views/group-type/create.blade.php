    ...
    <div class="card">
      <div class="card-body">
        <h6 class="card-title">{{$page_title}}</h6>
            ...
            @endif
          <form method="POST" action="{{url('group-type/add')}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="control-label">Group Type</label>
                        <input type="text" class="form-control" placeholder="ENTER GROUP TYPE NAME HERE" name="name" value="{{old('name')}}" required>
                    </div>
                </div><!-- Col -->              
