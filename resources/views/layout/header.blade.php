    ...
    <ul class="navbar-nav">
        ...
        <div class="dropdown-menu" aria-labelledby="appsDropdown">
          ...
          <div class="dropdown-body">
            <div class="d-flex align-items-center apps">
              ...
              <a href="{{ url('/profile') }}"><i data-feather="instagram" class="icon-lg"></i><p>Profile</p></a>
            </div>
          </div>
      ...
      <li class="nav-item dropdown nav-profile">
        <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          @if(Auth::user()->imageFileName != '' || Auth::user()->imageFileName != null)
              <img width="30%" height="30%" src="{{URL::asset('profile_images/'.Auth::user()->imageFileName)}}">
          @else
        ...
        <div class="dropdown-menu" aria-labelledby="profileDropdown">
          <div class="dropdown-header d-flex flex-column align-items-center">
            <div class="figure mb-3">
              @if(Auth::user()->imageFileName != '' || Auth::user()->imageFileName != null)
                  <img width="80%" height="80%" src="{{URL::asset('profile_images/'.Auth::user()->imageFileName)}}">
              @else
                <img src="{{ url('https://via.placeholder.com/80x80') }}" alt="">
              @endif
            </div>
            <div class="info text-center">
              <p class="name font-weight-bold mb-0">{{ Auth::user()->fname." ".Auth::user()->lname }}</p>
              <p class="email text-muted mb-3">{{ Auth::user()->emailid }}</p>
            </div>
          </div>
          <div class="info text-center pt-3">
            <p class="name font-weight-bold mb-0">{{ Auth::user()->socity->society_name }}</p>
            <p class="email text-danger mb-3">Expired Date : {{ Auth::user()->socity->end_date }}</p>
          </div>
          <hr>
          <div class="dropdown-body">
