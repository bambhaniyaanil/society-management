    ...
    <div class="card">
      <div class="card-body">
        <h6 class="card-title">{{$page_title}}</h6>
            ...
            @endif
          <form method="POST" action="{{route('mail-integrations.update', $mail->id)}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="control-label">SMTP User Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" placeholder="SMTP User Name" name="smtp_user_name" value="{{$mail->smtp_user_name}}" required>
                    </div>
                </div><!-- Col -->  
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="control-label">SMTP Password <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" placeholder="SMTP Password" name="smtp_password" value="{{$mail->smtp_password}}"  required>
                    </div>
                </div><!-- Col --> 
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="SMTP Host" name="smtp_host" value="{{$mail->smtp_host}}" required>
                    </div>
                </div><!-- Col -->
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="SMTP Port" name="smtp_port" value="{{$mail->smtp_port}}" required>
                    </div>
                </div><!-- Col -->
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Use SMTP Simple" name="use_smtp_simple" value="{{$mail->use_smtp_simple}}" required>
                    </div>
                </div><!-- Col -->
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="From Email" name="from_email" value="{{$mail->from_email}}" required>
                    </div>
                </div><!-- Col -->
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Replay Email" name="replay_email" value="{{$mail->replay_email}}" required>
                    </div>
                </div><!-- Col -->
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="exampleFormControlSelect1" name="status" required>
                            <option value="1" <?php if($mail->status == 1) echo 'selected'; ?>>Active</option>
                            <option value="0" <?php if($mail->status == 0) echo 'selected'; ?>>Deactive</option>
                        </select>
                    </div>
                </div><!-- Col -->
