    ...
    <div class="card">
      <div class="card-body">
        <h6 class="card-title">{{$page_title}}</h6>
            ...
            @endif
          <form method="POST" action="{{url('payment-voucher/add')}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="control-label">By Ledger (Debit)</label>
                        <select class="form-control w-100" id="mySelect2" name="buy_ledger_id" required>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select class="form-control js-example-basic-single w-100" id="exampleFormControlSelect1" name="to_ledger_id" required>
