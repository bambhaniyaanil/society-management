        ...
        <div class="row">
          ...
          <div class="col-md-12 pl-md-0">
            ...
            <div class="text-center">
                ...
                @endif 
              <form class="forms-sample" method="POST" action="{{ route('receipts-form-save') }}">
              {{ csrf_field() }}
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Enter Your Mobile Number" name="mobile_number" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" required>  
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Enter Your Chack No / Transaction No" name="check_transaction_no" required>  
                </div>
                <div class="form-group">
