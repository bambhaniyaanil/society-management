...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="{{url('receipts-voucher/receipt-form')}}">Receipts Voucher Form Data</a></li>
    ...
    <div class="card">
      <div class="card-body">
        <h6 class="card-title">{{$page_title}}</h6>
            ...
            @endif
          <form method="POST" action="{{route('receipts-voucher.update-form', $data->id)}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="control-label">Chack No / Transaction No</label>
                        <input type="text" class="form-control" placeholder="Enter Your Chack No / Transaction No" name="check_transaction_no" value="{{$data->check_transaction_no}}" required>  
                    </div>
                </div><!-- Col --> 
            ...
            <div class="mt-3">
                <a href="{{url('receipts-voucher/receipt-form')}}" type="button" class="btn btn-danger">Back</a>
