            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Email" name="s_user_email" value="{{$user->s_user_email}}"  required>
                    </div>
                </div><!-- Col --> 
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Mobile" name="s_user_mobile_number" value="{{$user->s_user_mobile_number}}"  required>
                    </div>
                </div><!-- Col --> 
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="WhatsApp Mobile" name="s_user_wp_number" value="{{$user->s_user_wp_number}}"  required>
                    </div>
                </div><!-- Col --> 
                ...
                <div class="col-sm-2">
                    <img width="100%" height="100%" src="{{URL::asset('public/users/'.$user->user_photo)}}">
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="exampleFormControlSelect1" name="role" required>
                            ...
                            @foreach($roles as $role)
                                <option value="{{$role->id}}" <?php if($role->id == $user->role) echo 'selected'; ?>>{{$role->role_name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div><!-- Col -->
